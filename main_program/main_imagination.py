...
parser.add_argument("--root-dir", default=r'D:\Graduate\6401\container-imagination-only-container-visualize\container-imagination-only-container-visualize',
                    type=str,
                    help="root directory of the container imagination")
parser.add_argument("--data-root-dir",default=r'D:\Graduate\6401\container-imagination-only-container-visualize\container-imagination-only-container-visualize\data',
                    type=str,
                    help="root directory of the data")
parser.add_argument("--data-name", type=str, help="name of the scene captured",default='Amazon_Accessory_Tray_pour_pca',)
parser.add_argument("--mesh-name",default='Amazon_Accessory_Tray_pour_pca_mesh_0',
                    type=str,
...
parser.add_argument(
    ...
    "--mp4",
    type=str,
    default=r"D:\Graduate\6401\container-imagination-only-container-visualize\container-imagination-only-container-visualize",
    help=
