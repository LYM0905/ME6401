...
from vibration import vib_type
...
class CupPour(object):
    ...
    def cup_pour(self, indent=0.01):
        ...
        """
        # Perform vibration before pouring
        material = what_material()  # Assume there is a function to determine the material of the cup
        vib_type(material, self.cup_id)  # Invoke the vibration function
