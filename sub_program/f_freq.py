...
for i in range(50):  # Assume there are 10 fillers
...
for i in range(num_steps):
    ...
    displacement_z = vibration_amplitude * np.cos(2 * np.pi * vibration_frequency_z * t)
    new_pos = [0, displacement_y, displacement_z]  # Vibrating along the yz plane
