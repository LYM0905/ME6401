...
vibration_frequency_x = 1.5  # Vibration frequency on x-axis
vibration_frequency_y = 1.5  # Vibration frequency on y-axis
...
for i in range(num_steps):
    ...
    new_pos = [displacement_x, displacement_y, 0]  # Vibrate on the horizontal plane
