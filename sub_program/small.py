...
camera_distance = 0.1  # Distance of the camera from the target point
...
# Add fillers
filler_ids = []
filler_urdf_path = "D:/Graduate/6401/container-imagination-only-container-visualize/container-imagination-only-container-visualize/object/s-m&m.urdf"  # Path for filler URDF
for i in range(100):  # Assuming there are 100 fillers
